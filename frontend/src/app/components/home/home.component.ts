...
export class HomeComponent implements OnInit, OnDestroy {
  ...
  constructor(private toastService: ToastService, private baseService: BaseService , private cryptoService: CryptoService, private socketService: SocketService, private modalService: NgbModal, private router: Router){
